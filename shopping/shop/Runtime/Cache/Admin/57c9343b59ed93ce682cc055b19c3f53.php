		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-3 col-md-6">
					<form class="form-horizontal" action="/myshop/shop/index.php/Admin/Login/login" method="post">
						...
						<img src="/myshop/shop/index.php/Admin/Login/code" onclick=this.src="/myshop/shop/index.php/Admin/Login/code/"+Math.random() />
