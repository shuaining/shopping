...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="<?php echo Admin_IMG_URL;?>y.jpg" class="radius-circle rotate-hover" height="50" alt="" />后台管理中心</h1>
  </div>
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="/myshop/shop/index.php/Admin/Index/right.html" name="right" width="100%" height="100%"></iframe>
</div>
