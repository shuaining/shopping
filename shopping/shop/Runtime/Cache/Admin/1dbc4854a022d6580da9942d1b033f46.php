...
<div class="panel admin-panel">
  ...
  <div class="padding border-bottom">
    <button type="button" class="button border-yellow" onclick="window.location.href='/myshop/shop/index.php/Admin/category/tianjia'"><span class="icon-plus-square-o"></span> 添加分类</button>
  </div>
