...
<link href="<?php echo Admin_CSS_URL;?>public.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="<?php echo Admin_JS_URL;?>jquery.min.js"></script>
<script type="text/javascript" src="<?php echo Admin_JS_URL;?>global.js"></script>
</head>
<body>
<div id="dcWrap"> <div id="dcHead">
 <div id="head">
  <div class="logo"><a href="index.html"><img src="<?php echo Admin_IMG_URL;?>dclogo.gif" alt="logo"></a></div>
  <div class="nav">
   <ul>
